...
Beam `main` is protected because it is the foundational orientation and anti-drift layer for the Prism suite. AIs should not freely rewrite foundational files on `main`.
